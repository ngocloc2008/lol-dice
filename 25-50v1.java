 ...
 $.get('https://raw.githubusercontent.com/ngocloc2008/lol-dice/master/user', function (data, status) {}).done(function (data) {
								...
								if (_gameResult == 'win') {
									...
									_prediction = _chance
										...
										if (_loseStreak == 1) {
											_prediction = 25;
											_chance = _prediction
											_betAmount = 0.00000002;
										}
										if (_loseStreak == 2) {
											_prediction = 25;
											_chance = _prediction
											_betAmount = 0.00000001;
										}
										if (_loseStreak == 3) {
											_prediction = 50;
											_chance = _prediction
										...
										if (_loseStreak == 18) {
												_prediction = 50;
												_chance = _prediction
												_betAmount = 0.00000256*2*1.5;
										
										}
										if (_loseStreak == 19) {
												_prediction = 25;
												_chance = _prediction
												_betAmount = 0.00000512*1.5;
										}		
										if (_loseStreak == 20) {
												_prediction = 25;
												_chance = _prediction
										...
										if (_loseStreak == 32) {
												_prediction = 25;
												_chance = _prediction
												_betAmount = _previous_betAmount * 2*2;
										}
										if (_loseStreak == 33) {
												_prediction = 50;
												_chance = _prediction
