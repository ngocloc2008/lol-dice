$('#body').css('background', 'linear-gradient(45deg, rgb(128, 0, 0) 0%, rgb(128, 0, 25) 50%, rgb(128, 128, 0) 100%)');
...
function min() {
    $('#basebetAmount').val((0.00000000).toFixed(8));
}
...
function reset() {
    ...
    $('#notification').html('<left><font style="color: #FFFF00; font-size: 20px;"><b style="font-size: 20px;">Luckygames Dice Bot V.2</b><br><a href="" target="_blank"></a><br>My Channel <a href="https://bit.ly/2wIwfKp">Technical Yadav</a></font>');
    $('#static').html('...');
    return;
}
function doBet() {
    if (run === true) {
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data.result === true) {
                    ...
                    $('#notification').html('<left><font style="color: #FFFF00; font-size: 18px;"><b style="font-size: 18px;"> Super Dice Bot</b><br><a href="" target="_blank"></a><br>My Channel <a href="https://goo.gl/7uEhmt">Technical Yadav</a></font>');
                    ...
                    if (betAmount >= balance) {
                        ...
                        if (overBalance != 0 && balance >= overBalance) {
                            ...
                            if (profit >= largestProfit) {
                                round = 0;
                                _prediction = Math.floor((Math.random() * (50 - 90 + 1)) + 90);
                            } else {
                                round++;
                                if (round % 1 === 0) {
                                    betAmount *= 1.1;
        ...
        $('#notification').html('<left><font style="color: #FFFF00; font-size: 20px;"><b style="font-size: 20px;"></b><br><a href="" target="_blank"></a><br>My Channel <a href="https://bit.ly/2wIwfKp">Technical Yadav</a></font>');
        return;
    }
}