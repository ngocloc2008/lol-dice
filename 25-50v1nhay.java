								...
								if (_gameResult == 'win') {
									...
									_prediction = _chance
										...
										if (_loseStreak == 32) {
												_prediction = 25;
												_chance = _prediction
												_betAmount = _previous_betAmount * 1;
										}
										if (_loseStreak == 33) {
												_prediction = 50;
												_chance = _prediction
